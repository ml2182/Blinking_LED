...
REM
REM Generated by Vivado on Sat Dec 13 01:37:16 +0000 2025
...
echo "xvlog --incr --relax -L uvm -prj tb_Blinking_LED_vlog.prj"
call xvlog  --incr --relax -L uvm -prj tb_Blinking_LED_vlog.prj -log xvlog.log
